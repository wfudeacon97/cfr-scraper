...
def printSubPartJson(currentTitle):
  if currentTitle.ChapterNum == chapterToParse:
    ...
    cfr = {}
    oid = {}
    jsonData['htmlUrl'] = currentTitle.TitleNum + "." + currentTitle.ChapterNum + "." + currentTitle.SubChapterNum + "." + currentTitle.PartNum + ".html#" + currentTitle.TitleNum + "." + currentTitle.ChapterNum + "." + currentTitle.SubPartNum
